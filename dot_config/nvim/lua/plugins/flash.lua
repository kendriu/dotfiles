return {
  ...
  keys = {
    ...
    -- Treesitter search (available in visual mode as alternative to S)
    { "R", mode = { "o", "x" }, function() require("flash").treesitter_search() end, desc = "Flash: Treesitter Search" },
    
    -- Toggle flash in command mode
    { "<c-s>", mode = { "c" }, function() require("flash").toggle() end, desc = "Flash: Toggle in Search" },
    
    -- Additional powerful keybindings
    -- Flash word under cursor
    { "<leader>fw", mode = { "n", "x", "o" }, function()
      require("flash").jump({
        pattern = vim.fn.expand("<cword>"),
      })
    end, desc = "Flash: Word under cursor" },
    
    -- Flash with prompt (custom search)
    { "<leader>fj", mode = { "n", "x", "o" }, function()
      require("flash").jump({
